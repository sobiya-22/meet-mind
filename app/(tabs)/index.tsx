      ...
      <SafeAreaView style={styles.container}>
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.upcomingMeetings}>
            ...
            {meetings.length === 0 ? (
              <Text style={{ color: '#999' }}>No upcoming meetings</Text>
            ) : (
...
const styles = StyleSheet.create({
  ...
  username: { fontFamily: 'MeetMindFont', color: '#023c8a', fontWeight: 'bold' },
  subtitle: { fontSize: 16, color: '#666', marginTop: 5 },
  quickActions: { paddingHorizontal: 20, paddingTop: 10, paddingBottom: 0 },
  upcomingMeetings: { paddingHorizontal: 20, paddingBottom: 10 },
  ...
  actionText: { marginTop: 10, fontSize: 16, color: '#333' },
  meetingCard: {
    backgroundColor: '#f5f5f5',
    borderRadius: 15,
    padding: 20,
  ...
  meetingHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
  meetingTitle: { fontSize: 18, fontWeight: 'bold', color: '#333', marginLeft: 10 },
  meetingTime: { fontSize: 16, color: '#666', marginBottom: 5 },
  joinButton: {
  ...
  recentActivity: { paddingHorizontal: 20, paddingBottom: 20 },
  activityCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#f5f5f5',
  ...
  activityContent: { marginLeft: 15 },
  activityTitle: { fontSize: 16, color: '#333' },
  activityTime: { fontSize: 14, color: '#666', marginTop: 5 },
